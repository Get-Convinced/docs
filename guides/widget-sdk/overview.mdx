...
<Note>
The unpublished `0.1.1-webmcp.3` candidate adds session-owned headless voice. It requires a matching backend change. See the [candidate migration](/guides/widget-sdk/events#candidate-session-owned-headless-voice) before testing it; the installation instructions below remain for published `.2`.
</Note>
