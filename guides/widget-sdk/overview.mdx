...
`@convinced/widget-sdk` 0.1.2 has a headless core. It manages a Convinced conversation, optional speech I/O, host tools, and session lifecycle without requiring React. Build every visual surface in your application, or opt into the package's `mountConvincedWidget()` convenience renderer.
...
<CardGroup cols={2}>
  ...
  <Card title="SDK API map" icon="code" href="/guides/widget-sdk/api-reference">Find the public 0.1.2 surface.</Card>
</CardGroup>
